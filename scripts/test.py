...
is_bilbowa = True if opts.F.startswith('bilbowa') else False

folder_path = os.path.abspath(opts.F)
# Initialize model
model = Model(model_path=os.path.abspath(opts.F), bilbowa=is_bilbowa)
